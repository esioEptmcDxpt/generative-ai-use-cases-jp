...
/**
 * Create a new TranslationSegment with default values and optional overrides
 * This helper function ensures type safety when creating or updating TranslationSegment objects
 * 
 * @param base - Base TranslationSegment or partial object with some properties
 * @param updates - Optional additional properties to override
 * @returns A complete TranslationSegment object
 */
export function createTranslationSegment(
  base: Partial<TranslationSegment>,
  updates: Partial<TranslationSegment> = {}
): TranslationSegment {
  // Create a new segment with required properties and defaults
  const segment: TranslationSegment = {
    text: base.text || '',
    needsTranslation: base.needsTranslation ?? true,
    translation: base.translation,
    lastTranslatedText: base.lastTranslatedText,
    requestTimestamp: base.requestTimestamp,
  };
